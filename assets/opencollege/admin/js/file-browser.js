...
RedactorPlugins.fileBrowser = {
	...
	init: function()
	{
		this.addBtnAfter('link', 'file-browser', 'File Browser', function(obj)
		{
			...
			obj.modalInit('File Browser', '<iframe src="/Ukopencollege/admin/media" style="width:780px;padding:10px; height:400px; border:0px; background:transparent;"></iframe>', 800);
