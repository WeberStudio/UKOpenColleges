      ...
      <div class="row-fluid ">
        <div class="span12">
          <div class="box paint color_18">
            <div class="title">
              <h4> <i class=" icon-bar-chart"></i><span>Recurring Invoices
                   </span> </h4>
            </div>
            <!-- End .title -->
              ...
              <table id="datatable_example" class="responsive table table-striped table-bordered" style="width:100%;margin-bottom:0; ">
                <thead>
                  <tr>
                    ...
                    <th class="no_sort to_hide_phone">Base Invoice </th>
                    <th class="ue no_sort">Start Date</th>
                    <th>End Date</th>
                    <th>Every</th>
                    <th class="ue no_sort">Next Date</th>
