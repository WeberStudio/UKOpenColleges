<table id="item_table" class="items table table-striped table-bordered">
	...
	<tbody>
		...
		<tr id="new_item" style="display: none;">
            ...
            <td><textarea id="item_description" style="width: 90%;"></textarea></td>
			<td style="vertical-align: top;"><input type="text" class="input-mini" id="item_quantity" style="width: 90%;" value=""></td>
			<td style="vertical-align: top;"><input type="text" class="input-mini" id="item_price" style="width: 90%;" value=""></td>
			<td style="vertical-align: top;">
		...
		<tr class="item">
            ...
            <td><textarea id="item_description" style="width: 90%;"><?php echo $item->item_description; ?></textarea></td>
			<td style="vertical-align: top;"><input type="text" id="item_quantity" style="width: 90%;" value="<?php echo format_amount($item->item_quantity); ?>"></td>
			<td style="vertical-align: top;"><input type="text" id="item_price" style="width: 90%;" value="<?php echo format_amount($item->item_price); ?>"></td>
			<td style="vertical-align: top;">
			...
			<td style="vertical-align: top;"><?php echo format_currency($item->item_tax_total); ?></td>
			<td style="vertical-align: top;"><?php echo format_currency($item->item_total); ?></td>
			<td style="vertical-align: top;">
