			  	...
			  	<div class="btn-group1">
                	<div class="btn-group ">
                      ...
                      <ul class="dropdown-menu" style="text-align:left;">
                        <li><a target="_blank" data-placement="left"  rel="tooltip" data-original-title="<?php echo lang('pdf');?>" href="<?=base_url().'admin/invoices/pdf_view/'.$invoice['invoice_id'].'/'.$invoice['template_id']?>" ><i class="icon-print"></i> Open PDF </a></li>
