	...
	<div class="clear"></div>
			...
			<h3><?php echo lang('form_register');?></h3>
				...
				<p class="form-row form-row-last update_totals_on_change" id="billing_postcode_field">
					...
					<?php echo form_dropdown('zone_id', $zones_menu, set_value('zone_id', $zone_id), 'id="f_zone_id" class="country_to_state form-row-first update_totals_on_change country_select chzn-done"');?>
				</p>
				<div class="clear"></div>
